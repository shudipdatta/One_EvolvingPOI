...
public class GenerateScenario {
	...
	private ArrayList<PhotoPOI.Photo> PositionPhotos(int totalPhoto, int focus, int angle) {
		int range = focus * 2;
	...
	public static GenerateScenario GetInstance(int actualPoi,
		...
		if(totalPhotoMap.containsKey(totalPhoto) == false) {
			totalPhotoMap.put(totalPhoto, generateScenario.PositionPhotos(totalPhoto, focus, angle));
		}
