...
public class PhotoRouter_Choose {
	 ...
	 * 
	 */
	public PhotoRouter_Choose (PhotoRouter router) {
		this.router = router;
...
//			    double timeElapsed = SimClock.getTime() - rcvdPhotoGroupSeq.timeStamp;
//			    double currentProbability = 1-Math.exp(-rcvdPhotoGroupSeq.lambda*timeElapsed);
//			    this.nodeMet = (int) Math.floor(rcvdPhotoGroupSeq.lambda*timeElapsed);
//			    System.out.println(currentProbability + "\t" + this.nodeMet);
			}
